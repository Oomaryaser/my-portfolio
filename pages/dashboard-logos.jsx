// File: pages/dashboard-logos.jsx
...
export default function Dashboard() {
  ...
  const fetchImgs = async () => {
    ...
    setLoadingImgs(true);
    try {
    const res  = await fetch(`/api/logo-categories/${categoryForUpload}/images`);
      const data = await res.json();
  ...
  const saveEdit = async () => {
    ...
    try {
      ...
      await fetch(`/api/logo-categories/${editId}`, { method: 'PUT', body: fm });
  ...
  const uploadFiles = async () => {
    ...
    try {
      for (let f of files) {
        ...
        await fetch(`/api/logo-categories/${categoryForUpload}/images`, {
          method: 'POST',
          body: fm
        });
      }
